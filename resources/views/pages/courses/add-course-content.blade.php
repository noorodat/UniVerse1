    ...
    <div class="edu-contact-us-area eduvibe-contact-us edu-section-gap bg-color-white">
        <div class="container eduvibe-animated-shape">
            ...
            <div class="row g-5 mt--20 justify-content-center">
                ...
                <div class="col-lg-6">
                    <form enctype="multipart/form-data" method="POST" action="{{ route('add-course-content', $course) }}">
                        @csrf
                        <div class="form-group">
                            <label class="mb-2" for="">Topic name</label>
                            <input type="text" name="topicName" class="form-control form-control-lg">
                        </div>
                        <div class="form-group">
