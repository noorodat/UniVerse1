            ...
            <div class="row g-5">
                <div class="col-xl-8 col-lg-7">
                    <div class="course-details-content">
                        ...
                        <a href="{{ route('go-add-cousre-content', $course) }}"
                            class="edu-btn btn-bg-alt w-100 mb-2 text-center">Add new topic</a>
                        <ul class="edu-course-tab nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="curriculum-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="false">Curriculum (Edit)</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                                ...
                                                <div class="edu-accordion-item">
                                                    @foreach ($topicsWithMaterials as $topicTitle => $topicCollection)
                                                        ...
                                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                                            ...
                                                            <a href="{{ route('go-add-content-to-topic', ['course' => $course, 'courseTopic' => $topicTitle]) }}"
                                                                class="edu-btn btn-bg-alt w-100 mb-2 text-center">Add
                                                                content</a>
                                                            <a
                                                            href="{{route('go-delete-topic', ['course' => $course, 'topicTitle' => $topicTitle])}}"
                                                                class="edu-btn btn-bg-alt w-100 mb-2 text-center delete-topic-hover text-danger">
                                                                Delete Topic
                                                            </a>
                                                            {{-- href="{{route('go-add-content-to-topic', ['course' => $course, 'courseTopic' => $topicTitle])}}" --}}
                                                                            ...
                                                                            <li>
                                                                                ...
                                                                                @if (!$isEnrolled)
                                                                                    <div class="icon d-flex"
                                                                                        ...
                                                                                        <a class="p-2"
                                                                                            href="{{ route('course.edit', $course->id) }}?topicTitle={{ $topicTitle }}&collection={{ $collection->file }}&file_name={{ $collection->file_name }}">
                                                                                            <i
                                                                                                class="fa-solid fa-pen-to-square"></i>
                                                                                        </a>
                                                                                        <form enctype="multipart/form-data"
                                                                                            method="POST"
                                                                                            action="{{ route('delete-course-content', $collection->id) }}">
                                                                                            @csrf
                                                                                            <button type="submit"
                                                                            ...
                                                                            <li>
                                                                                ...
                                                                                @if (!$isEnrolled)
                                                                                    <div class="icon d-flex"
                                                                                        style="cursor: pointer">
                                                                                        <a class="p-2"
                                                                                            href="{{ route('course.edit', $course->id) }}?topicTitle={{ $topicTitle }}&collection={{ $collection->video }}&file_name={{ $collection->video_name }}">
                                                                                            <i
                                                                                                class="fa-solid fa-pen-to-square"></i>
                                                                                        </a>
                                                                                        <form enctype="multipart/form-data"
                                ...
                                <div class="course-tab-content">
                                    <div class="course-author-wrapper">
                                        ...
                                        <div class="author-content">
                                            <h6 class="title">
                                                <a
                                                    href="instructor-profile.html">{{ $course->instructor->user->name }}</a>
                                            </h6>
                                ...
                                <div class="course-tab-content">
                                    ...
                                    <div class="comment-wrapper pt--40">
                                        ...
                                        <div class="edu-comment">
                                            <div class="thumbnail">
                                                <img src="/assets/images/course/student-review/student-1.png"
                                                    alt="Comment Images">
                                            </div>
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="eduvibe-sidebar course-details-sidebar">
                        <div class="d-flex gap-1 read-more-btn mt--30">
                            <a href="{{ route('go-edit-cousre-preview', $course) }}"
                                class="edu-btn btn-bg-alt w-100   text-center">Edit course</a>
                        </div>
                        <div class="inner">
                            <div class="eduvibe-widget">
                                <div class="video-area">
                                    <div class="thumbnail video-popup-wrapper">
                                        <img class="radius-small w-100" src="{{ asset($course->image) }}"
                                            alt="Course Images">
                                        <a href="{{ $previewType == 'youtube' ? $course->preview_video : asset($course->preview_video) }}"
                                ...
                                <div class="eduvibe-widget-details mt--35">
                                    <div class="widget-content">
                                        <ul>
                                            <li><span><i class="icon-time-line"></i>
                                                    Duration</span><span>{{ $course->duration }} Hours</span></li>

                                            <li><span><i class="icon-user-2"></i> Enrolled</span><span>0</span></li>

                                            <li><span><i class="icon-draft-line"></i>
                                                    Lessons</span><span>{{ $course->number_of_lessons }}</span></li>

                                            <li><span><i class="icon-user-2-line_tie"></i>
                                                    Instructor</span><span>{{ $course->instructor->user->name }}</span>
                                            </li>
                                        </ul>
                                        @if ($isEnrolled)
                                            <div class="read-more-btn mt--45">
                                                <a href="{{ route('show-unlocked-course', $course) }}"
                                                    class="edu-btn btn-bg-alt w-100 text-center">Show content</a>
                                            </div>
                                        @else
                                            <div class="read-more-btn mt--45">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="course-details.html">
                                                    <img class="w-100" src="{{ asset($course->image) }}"
                                                        alt="Course Thumb">
                                                </a>
                                                ...
                                                <div class="top-position status-group left-bottom">
                                                    <span
                                                        class="eduvibe-status status-03">{{ $course->department->title }}</span>
                                                </div>
                                            </div>
                                            <div class="content">
                                                <div class="card-top">
                                                    <div class="author-meta">
                                                        <div class="author-thumb">
                                                            <a href="instructor-profile.html">
                                                                <img src="{{ asset($course->instructor->user->image) }}"
                                                                    alt="Author Images">
                                                                <span
                                                                    class="author-title">{{ $course->instructor->user->name }}</span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <ul class="edu-meta meta-02">
                                                        <li><i
                                                                class="icon-file-list-3-line"></i>{{ $course->number_of_lessons }}
                                                            Lessons</li>
                                                    </ul>
                                                </div>
                                                <h6 class="title"><a
                                                ...
                                                <div class="price-list price-style-02">
                                                    ...
                                                    <div class="read-more-btn">
                                                        <a class="edu-btn btn-medium btn-white"
                                                            href="{{ route('course.show', $course) }}">Enroll Now<i
