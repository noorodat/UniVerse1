                                        ...
                                        <div class="card contact_list text-center">
                                            <div class="card-body">
                                                <div class="user-content">
                                                    <div class="user-info">
                                                        <div class="user-img">
                                                            <i class="{{$department->image}} fs-2"></i>
                                                        </div>
                                                        <div class="user-details">
                                                            <h4 class="user-name mb-0">{{ $department->title }}</h4>
                                                            <h4 class="user-name mt-2">{{ $department->description }}</h4>
                                                        </div>
                                                    </div>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <button data-bs-toggle="modal"
                                                                data-bs-target="#exampleModal3{{ $department->id }}"
                                                                class="w-100 dropdown-item" type="button"
                                                                style="border: none; outline: none; background-color: inherit; text-align: left">
                                                                Delete
                                                            </button>
                                                            <a class="dropdown-item"
                                                                href="{{ route('department.edit', ['department' => $department]) }}">Edit</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="contact-icon mt-3">
                                                    <span class="badge badge-success light" style="font-size: 14px">Number
                                                        of courses: {{ $department->number_of_courses }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
