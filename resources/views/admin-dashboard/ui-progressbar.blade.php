...
<!-- Mirrored from akademi.dexignlab.com/xhtml/ui-progressbar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Sep 2023 15:47:55 GMT -->
<head>
				...
				<div class="col-xl-12">
					<div class="page-titles">
						<div class="d-flex align-items-center">
							<h2 class="heading">Progressbar</h2>
						</div>
					</div>
				</div>
				 <!--element-area-->
