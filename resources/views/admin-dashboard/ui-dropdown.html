...
<!-- Mirrored from akademi.dexignlab.com/xhtml/ui-dropdown.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Sep 2023 15:47:55 GMT -->
<head>
					...
					<div class="demo-right ">
                        <div class="demo-right-inner dlab-scroll " id="right-sidebar">
                            ...
                            <ul class="navbar-nav" id="menu-bar">
								...
								<li><a href="#disable-active" class="scroll">Disable And Active Items</a></li>
								
                                <li><a href="#align-right" class="scroll">Align Right</a></li>
								<li><a href="#dropup" class="scroll">Dropup</a></li>
