...
<!-- Mirrored from akademi.dexignlab.com/xhtml/ui-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Sep 2023 15:47:56 GMT -->
<head>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">
                                                    Extra small<br>
                                                    <small class="text-primary">&lt;576px</small>
                                                </th>
                                                <th class="text-center">
                                                    Small<br>
                                                    <small class="text-primary">≥576px</small>
                                                ...
                                                <th class="text-center">
                                                    Medium<br>
                                                    <small class="text-primary">≥768px</small>
                                                </th>
                                                <th class="text-center">
                                                    Large<br>
                                                    <small class="text-primary">≥992px</small>
                                                </th>
                                                <th class="text-center">
                                                    Extra large<br>
                                                    <small class="text-primary">≥1200px</small>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
