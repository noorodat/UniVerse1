								...
								<div class="page-title flex-wrap">
									...
									<div>
										<select class="image-select bs-select dashboard-select me-3" aria-label="Default">
										 ...
										 <a class="btn btn-primary" href="{{route('go-add-student')}}">+ New Student</a>						
									</div>
								</div>
							</div>
							<!--column-->
											...
											<tr>
												...
												<td>
													<div class="trans-list">
														<img src="{{ url('/images/' . $student->image) }}" alt="" class="avatar avatar-sm me-3">
														{{-- src="{{ url('/images/' . $cat->image) }}" --}}
														<h4><a href="{{ route('go-student-details', ['student' => $student]) }}">{{ $student->name }}</a></h4>
													</div>
												</td>
												<td>
												...
												<td>
													<div class="d-flex">
														<div class="icon-box icon-box-sm bg-light me-2 studentContactBox">
															...
															<span class="studentPhone studentContact">{{$student->phone}}</span>
														</div>
														<div class="icon-box icon-box-sm bg-light studentContactBox">
															...
															<span class="studentEmail studentContact"><a href="mailto:{{$student->email}}">{{$student->email}}</a></span>
														</div>
													</div>
												</td>
												<td>
